...
declare module "fs" {
    ...
    /** Constant for fs.access(). File is visible to the calling prcs. */
    export var F_OK: number;
    /** Constant for fs.access(). File can be read by the calling prcs. */
    export var R_OK: number;
    /** Constant for fs.access(). File can be written by the calling prcs. */
    export var W_OK: number;
    /** Constant for fs.access(). File can be executed by the calling prcs. */
